  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <h3><i class="fa-solid fa-user "></i>Vidya A</h3>
          <h3><i class="fa-solid fa-envelope"></i> vidyakala1999@gmail.com</h3>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/vidya-a-a78058286?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
